...
fun CondominioNavGraph(navController: NavHostController = rememberNavController()) {
    NavHost(navController = navController, startDestination = "login") {
        composable("login") {
            val viewModel: com.example.condominio.ui.screens.login.LoginViewModel = org.koin.androidx.compose.koinViewModel()
        ...
        composable("unit_selection") {
            val viewModel: com.example.condominio.ui.screens.UnitSelectionViewModel = org.koin.androidx.compose.koinViewModel()
            val uiState by viewModel.uiState.collectAsState()
